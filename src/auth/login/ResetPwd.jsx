...
function ResetPwd() {
    ...
    const submitHander = async () => {
        try {
            ...
            const { data } = await axios.post(VERIFY_OTP + userId, { otp: otp }, config)
            ...
            if (data.statusCode === 200) {
                ...
                const result = await axios.post( RESET_PWD + userId, { password: newpassword , confirmpassword: confirmpassword },config)
